...
SIMPLE_WORDS = {
    ...
    'authorities': ('officials', 'authorities = officials in charge'),
    'authority': ('official', 'authority = official power or office'),
    'department': ('office', 'department = government office or part'),
    'officials': ('leaders', 'officials = people in charge'),
    'military': ('army', 'military = army or armed forces'),
    'minister': ('leader', 'minister = government leader'),
    'congress': ('lawmakers', 'congress = national lawmakers'),
    'legislation': ('law', 'legislation = law or set of laws'),
    'economic': ('money-related', 'economic = related to money and jobs'),
    'economy': ('money system', 'economy = system of money and jobs'),
    'recession': ('economic slowdown', 'recession = period when business gets weaker'),
    'inflation': ('rising prices', 'inflation = prices going up'),
    'official': ('formal', 'official = formal or approved'),
    'statement': ('message', 'statement = spoken or written message'),
    'annually': ('every year', 'annually = every year'),
    'monthly': ('every month', 'monthly = every month'),
    'weekly': ('every week', 'weekly = every week'),
    'facility': ('building', 'facility = building or place for a purpose'),
    'facilities': ('buildings', 'facilities = buildings or places'),
    'currently': ('now', 'currently = now'),
    'previously': ('before', 'previously = before now'),
    ...
    'resigned': ('quit', 'resigned = quit a job'),
    'acquired': ('got', 'acquired = got'),
    'committed': ('did', 'committed = carried out'),
    'suspect': ('person thought guilty', 'suspect = person police think may be guilty'),
    'suspects': ('people thought guilty', 'suspects = people police think may be guilty'),
    'alleged': ('claimed', 'alleged = said without proof'),
    'allegedly': ('reportedly', 'allegedly = said without proof'),
    'injured': ('hurt', 'injured = hurt'),
    'fatal': ('deadly', 'fatal = causing death'),
    'deceased': ('dead', 'deceased = dead person'),
    'vehicle': ('car', 'vehicle = car or transport'),
    'vehicles': ('cars', 'vehicles = cars or transport'),
    'residence': ('home', 'residence = home'),
    'residential': ('home', 'residential = for homes'),
    'occurred': ('happened', 'occurred = happened'),
    'commonly': ('often', 'commonly = often'),
    'substantial': ('large', 'substantial = large'),
    'substantially': ('greatly', 'substantially = by a large amount'),
    'maintain': ('keep', 'maintain = keep'),
    'maintained': ('kept', 'maintained = kept'),
    'obtain': ('get', 'obtain = get'),
    'obtained': ('got', 'obtained = got'),
    'utilize': ('use', 'utilize = use'),
    'utilized': ('used', 'utilized = used'),
    'commencement': ('start', 'commencement = start'),
    'termination': ('end', 'termination = end'),
    'notwithstanding': ('despite', 'notwithstanding = despite'),
    'subsequent': ('later', 'subsequent = later'),
    'consequently': ('so', 'consequently = so'),
    'endeavor': ('try', 'endeavor = try'),
    'endeavored': ('tried', 'endeavored = tried'),
    'sustain': ('keep', 'sustain = keep going'),
    'sustained': ('kept', 'sustained = kept'),
    'encountered': ('met', 'encountered = met or faced'),
    'commuter': ('person traveling to work', 'commuter = person traveling to work'),
    'commuters': ('people traveling to work', 'commuters = people traveling to work'),
    'evacuated': ('moved out', 'evacuated = moved people out for safety'),
    'evacuation': ('moving people out', 'evacuation = moving people out for safety'),
    'detained': ('held', 'detained = held by police'),
    'detention': ('holding', 'detention = keeping someone held'),
}
